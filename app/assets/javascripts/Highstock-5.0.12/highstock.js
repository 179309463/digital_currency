...
(function(L, T) {
	...
	(function(a) {
		...
		a.Fx.prototype = {
			...
			step: function(n) {
				var h = +new Date,
					...
					m = r.duration,
					f = r.curAnim;
				x.attr && !x.element ? n = !1 : n || h >= m + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), u = f[this.prop] = !0, a.objectEach(f, function(a) {
					!0 !== a && (u = !1)
				}), u && t && t.call(x), n = !1) : (this.pos = r.easing((h - this.startTime) / m), this.now = this.start + (this.end - this.start) * this.pos, this.update(), n = !0);
				return n
			},
		...
		a.attr = function(n, h, u) {
			...
			a.isString(h) ? a.defined(u) ?
				n.setAttribute(h, u) : n && n.getAttribute && (r = n.getAttribute(h)) : a.defined(h) && a.isObject(h) && a.objectEach(h, function(a, h) {
					n.setAttribute(h, a)
				});
			return r
		};
		...
		a.formatSingle = function(n, h) {
			...
			/f$/.test(n) ? (u = (u = n.match(u)) ? u[1] : -1, null !== h && (h = a.numberFormat(h, u, r.decimalPoint, -1 < n.indexOf(",") ? r.thousandsSep : ""))) : h = a.dateFormat(n, h);
			return h
		};
		...
		a.Color.prototype = {
			...
			get: function(a) {
				var h = this.input,
					r = this.rgba,
					n;
				this.stops ? (n = D(h), n.stops = [].concat(n.stops), E(this.stops, function(h, m) {
					n.stops[m] = [n.stops[m][0], h.get(a)]
				})) : n = r && B(r[0]) ? "rgb" === a || !a && 1 === r[3] ? "rgb(" + r[0] + "," + r[1] + "," + r[2] + ")" : "a" === a ? r[3] : "rgba(" + r.join(",") + ")" : h;
				return n
			},
			brighten: function(a) {
				var h, r = this.rgba;
				if (this.stops) E(this.stops, function(h) {
					h.brighten(a)
				});
				else if (B(a) && 0 !== a)
	...
	(function(a) {
		...
		d(E.prototype, {
			...
			colorGradient: function(C, k, c) {
				...
				d && (q = C[d], w = z.gradients, g = C.stops, R = c.radialReference, H(q) && (C[d] =
					...
					}), "radialGradient" === d && R && !t(q.gradientUnits) && (f = q, q = y(q, z.getRadialAttr(R, f), {
					gradientUnits: "userSpaceOnUse"
				})), l(q, function(a, C) {
					"id" !== C && p.push(C, a)
				}), l(g, function(a) {
			...
			attr: function(a, k, c, z) {
				...
				"string" === typeof a ? q = (this[a + "Getter"] || this._defaultGetter).call(this, a, b) : (l(a, function(k, C) {
					e = !1;
					z || Q(this, C);
					this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(C) && (d || (this.symbolAttr(a), d = !0), e = !0);
					!this.rotation || "x" !== C && "y" !== C || (this.doTransform = !0);
					e || (y = this[C + "Setter"] || this._defaultSetter, y.call(this, k, C, b), this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(C) && this.updateShadows(C, k, y))
			...
			symbolAttr: function(a) {
				var k = this;
				e("x y r start end width height innerR anchorX anchorY".split(" "), function(C) {
					k[C] = I(a[C], k[C])
				});
				k.attr({
			...
			css: function(a) {
				...
				y && (C && (a = d(C, c)), b = this.textWidth = a && a.width && "auto" !== a.width && "text" === z.nodeName.toLowerCase() && k(a.width), this.styles = a, b &&
					...
					}), q && n(z, "style", q)), this.added && ("text" === this.element.nodeName && this.renderer.buildText(this), a && a.textOutline && this.applyTextOutline(a.textOutline)));
				return this
			},
				...
				if (!C) {
					if (l.namespaceURI === this.SVG_NS ||
						...
						try {
							...
							}) && f("none"), C = l.getBBox ? d({}, l.getBBox()) : {
								width: l.offsetWidth,
			...
			shadow: function(a, k, c) {
				...
				if (!a) this.destroyShadows();
					...
					for (z = 1; z <= q; z++) l = b.cloneNode(0), d = 2 * q + 1 - 2 * z, n(l, {
						isShadow: "true",
						...
						fill: "none"
					}), c && (n(l, "height", Math.max(n(l, "height") - d, 0)), l.cutHeight = d), k ? k.element.appendChild(l) : b.parentNode.insertBefore(l, b), C.push(l);
					this.shadows = C
				}
				return this
			},
		...
		E.prototype.translateXSetter = E.prototype.translateYSetter = E.prototype.rotationSetter = E.prototype.verticalAlignSetter = E.prototype.scaleXSetter = E.prototype.scaleYSetter = function(a, k) {
			this[k] = a;
			this.doTransform = !0
		};
		...
		d(B.prototype, {
			...
			getSpanWidth: function(a, k) {
				...
				!M && this.forExport && (c = this.measureSpanWidth(k.firstChild.data, a.styles));
				return c
			},
						...
						e(d, function(k) {
							if ("" !== k || 1 === d.length) {
								...
								f.test(k) && (I = k.match(f)[1].replace(/(;| |^)color([ :])/,
									"$1fill$2"), n(e, "style", I));
								w.test(k) && !l && (n(e, "onclick", 'location.href\x3d"' + k.match(w)[1] + '"'), r(e, {
									cursor: "pointer"
								}));
								...
								if (" " !== k) {
									...
									if (J) {
										...
										for (H && (G = z.applyEllipsis(a,
												e, k, J)); !H && p && (C.length || m.length);) a.rotation = 0, A = z.getSpanWidth(a, e), k = A > J, void 0 === G && (G = k), k && 1 !== C.length ? (e.removeChild(e.firstChild), m.unshift(C.pop())) : (C = m, m = [], C.length && !K && (e = g.createElementNS(N, "tspan"), n(e, {
											dy: h,
											x: v
										}), I && n(e, "style", I), c.appendChild(e)), A > J && (J = A)), C.length && e.appendChild(g.createTextNode(C.join(" ").replace(/- /g, "-")));
										a.rotation = Q
									}
									q++
								}
			...
			symbol: function(a, k, c, z, l,
				...
				var q = this,
					...
					v, M;
				G ? (y = this.path(p), y.attr("fill", "none"), d(y, {
					symbolName: w,
					x: k,
					y: c,
					width: z,
					height: l
				}), b && d(y, b)) : f && (v = a.match(C)[1], y = this.image(v), y.imgwidth = I(P[v] && P[v].width, b && b.width), y.imgheight = I(P[v] && P[v].height, b && b.height), M = function() {
					y.attr({
						width: y.width,
						height: y.height
					})
					...
					x: k,
					y: c
				}), y.isImg = !0, t(y.imgwidth) && t(y.imgheight) ? M() : (y.attr({
					width: 0,
					height: 0
				}), x("img", {
					onload: function() {
				...
				if (this.added) {
					...
					if ("SPAN" === d.tagName) {
						...
						y !== this.cTT && (J = a.fontMetrics(d.style.fontSize).b, D(c) && this.setSpanRotation(c, q, J), F(d, {
							width: "",
							whiteSpace: K || "nowrap"
						}), d.offsetWidth > w && /[ \-]/.test(d.textContent || d.innerText) && F(d, {
							width: w + "px",
							display: "block",
							whiteSpace: K || "normal"
	...
	(function(a) {
		...
		a.svg || (B = {
			...
			getSpanCorrection: function(a, b, c, d, e) {
				...
				e && "left" !==
					e && (this.xCorr -= a * c * (0 > q ? -1 : 1), d && (this.yCorr -= l * c * (0 > f ? -1 : 1)), D(this.element, {
						textAlign: e
					}))
			},
			...
			shadow: function(a, d, c) {
				...
				if (a) {
					A = p(a.width, 3);
					J = (a.opacity || .15) / A;
					for (q = 1; 3 >= q; q++) m = 2 * A + 1 - 2 * q, c && (M = this.cutOffPath(z.value, m + .5)), k = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"', m, '" filled\x3d"false" path\x3d"', M, '" coordsize\x3d"10 10" style\x3d"', f.style.cssText, '" /\x3e'], l = F(g.prepVML(k), null, {
						left: b(v.left) + p(a.offsetX, 1),
						top: b(v.top) + p(a.offsetY, 1)
					}), c && (l.cutOff = m + 1), k = ['\x3cstroke color\x3d"', a.color || "#000000", '" opacity\x3d"',
						J * q, '"/\x3e'
				...
				return m(f, {
					...
					getCSS: function(a) {
						var c = a.element,
							...
							e = z + this.height,
							z = {
								clip: "rect(" + Math.round(k ? d : z) + "px," + Math.round(k ? e : c) + "px," + Math.round(k ? c : e) + "px," + Math.round(k ? z : d) + "px)"
							};
						!k && a.docMode8 && "DIV" === b &&
							m(z, {
								width: c + "px",
			...
			color: function(b, d, c, e) {
				...
				if (p) {
					...
					1 > J[0] && b.push([1, J[1]]);
					x(b, function(k, c) {
						q.test(k[1]) ? (y = a.color(k[1]), z = y.get("rgb"), g = y.get("a")) : (z = k[1], g = 1);
						r.push(100 * k[0] + "% " + z);
						c ? (A = g, C = z) : (m = g, H = z)
					});
					if ("fill" === c)
			...
			this.init.apply(this, arguments)
		}, E.prototype = d(v.prototype, B), a.Renderer = E);
	...
	(function(a) {
		...
		a.Tick.prototype = {
			addLabel: function() {
				...
				B(m) ? m && m.attr({
					text: x
				}) : (this.labelLength = (this.label = m = B(x) && e.enabled ? t.renderer.text(x, 0, 0, e.useHTML).css(n(e.style)).add(a.labelGroup) : null) && m.getBBox().width, this.rotation = 0)
			},
			...
			getPosition: function(a, h, n, m) {
				...
				return {
					x: a ? f.translate(h + n, null, null, m) + f.transB : f.left + f.offset + (f.opposite ? (m && g.oldChartWidth || g.chartWidth) - f.right - f.left : 0),
					y: a ? e - f.bottom + f.offset - (f.opposite ? f.height : 0) : e - f.translate(h + n, null, null, m) - f.transB
				}
			},
			...
			renderGridLine: function(a, h, n) {
				...
				if (!a && g && (a = m.getPlotLinePath(d + b, g.strokeWidth() * n, a, !0))) g[this.isNew ? "attr" : "animate"]({
					d: a,
					opacity: h
				})
			},
			renderMark: function(a, n, t) {
				...
				var H = h(f[d + "Width"], !e && m.isXAxis ? 1 : 0),
					f = f[d + "Color"];
				p && (m.opposite && (p[0] = -p[0]), A && (this.mark = b = g.path().addClass("highcharts-" + (e ? e + "-" : "") + "tick").add(m.axisGroup), b.attr({
					stroke: f,
					"stroke-width": H
				})), b[A ? "attr" : "animate"]({
		...
		a.extend(I.prototype, {
				...
				m(a.series, function(k) {
					if (k.visible || !c.options.chart.ignoreHiddenSeries) {
						...
						if (a.isXAxis) b = k.xData, b.length && (k = D(b), v(k) || k instanceof Date || (b = p(b, function(a) {
							return v(a)
						}), k = D(b)), a.dataMin = Math.min(w(a.dataMin, b[0]),
			...
			getMinorTickPositions: function() {
				var a =
					...
					y = e - f;
				if (y && y / l < a.len / 3)
					if (a.isLog) m(this.paddedTicks, function(k, c, b) {
			...
			adjustForMinRange: function() {
				var a = this.options,
					...
					b = this.max,
					l, d, e, f, y, p, g, v;
				this.isXAxis && void 0 === this.minRange && !this.isLog && (r(a.min) || r(a.max) ? this.minRange = null : (m(this.series, function(a) {
					p = a.xData;
			...
			getClosest: function() {
				...
				this.categories ? a = 1 : m(this.series, function(k) {
					...
					!k.noSharedTooltip && r(c) && b && (a = r(a) ? Math.min(a, c) : c)
				});
				return a
			},
			nameToX: function(a) {
			...
			updateNames: function() {
				var a = this;
				0 < this.names.length && (this.names.length = 0, this.minRange = this.userMinRange, m(this.series || [], function(k) {
					k.xIncrement = null;
			...
			setAxisTranslation: function(a) {
				...
				if (g || y || b) l = k.getClosest(), f ? (d = f.minPointOffset, e = f.pointRangePadding) : m(k.series, function(a) {
					...
					b = Math.max(b, c);
					k.single || (d = Math.max(d, H(a) ? 0 : c / 2), e = Math.max(e, "on" === a ? 0 : c))
				}), f = k.ordinalSlope && l ? k.ordinalSlope / l : 1, k.minPointOffset = d *= f, k.pointRangePadding = e *= f, k.pointRange = Math.min(b, c), g && (k.closestPointRange = l);
				a && (k.oldTransA = p);
				k.translationSlope =
			...
			alignToOthers: function() {
				var a = {},
					c, b = this.options;
				!1 === this.chart.options.chart.alignTicks || !1 === b.alignTicks || this.isLog || m(this.chart[this.coll], function(k) {
					var b = k.options,
			...
			zoom: function(a, c) {
				...
				if (a !== this.min || c !== this.max) this.allowZoomOutside || (r(k) && (a < d && (a = d), a > l && (a = l)), r(b) && (c < d && (c = d), c > l && (c = l))), this.displayBtn = void 0 !== a || void 0 !== c, this.setExtremes(a, c, !1, void 0, {
					trigger: "zoom"
				});
				return !0
			},
			...
			renderUnsquish: function() {
				...
				if (this.autoRotation) w > y && w > g.h ? p.rotation = this.labelRotation : this.labelRotation = 0;
					...
					for (G.textOverflow = "clip", I = b.length; !e && I--;)
						if (A = b[I], y = l[A].label) y.styles && "ellipsis" === y.styles.textOverflow ? y.css({
								textOverflow: "clip"
							}) :
							l[A].labelLength > f && y.css({
								width: f + "px"
							}), y.getBBox().height > this.len / b.length - (g.h - g.f) && (y.specCss = {
								textOverflow: "ellipsis"
							});
				p.rotation && (G = {
			...
			addTitle: function(a) {
				var c = this.chart.renderer,
					...
					d;
				this.axisTitle || ((d = l.textAlign) || (d = (k ? {
						low: "left",
						middle: "center",
						high: "right"
					} : {
			...
			getOffset: function() {
				...
				a.axisGroup || (a.gridGroup = l.g("grid").attr({
					zIndex: d.gridZIndex || 1
				}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (t || "")).add(u), a.axisGroup = l.g("axis").attr({
					zIndex: d.zIndex || 2
				}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (t || "")).add(u), a.labelGroup = l.g("axis-labels").attr({
					zIndex: H.zIndex || 7
				}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (t || "")).add(u));
				v || a.isLinked ? (m(e, function(c, b) {
						a.generateTick(c, b)
					}), a.renderUnsquish(), !1 === H.reserveSpace ||
					0 !== p && 2 !== p && {
						1: "left",
						3: "right"
					}[p] !== a.labelAlign && "center" !== a.labelAlign || m(e, function(a) {
			...
			render: function() {
				...
				if (b.hasData() ||
					p) b.minorTickInterval && !b.categories && m(b.getMinorTickPositions(), function(a) {
					b.renderMinorTick(a)
					...
					0 === l % 2 && c < b.max && u <= b.max + (d.polar ? -n : n) && (A[c] || (A[c] = new a.PlotLineOrBand(b)), t = c + n, A[c].options = {
						from: f ? y(t) : t,
						to: f ? y(u) : u,
						color: H
					}, A[c].render(), A[c].isActive = !0)
				}), b._addedPlotLB || (m((e.plotLines || []).concat(e.plotBands ||
					[]), function(a) {
				...
				m([w, I, A], function(a) {
					...
					G(function() {
						for (b = l.length; b--;) a[l[b]] && !a[l[b]].isActive && (a[l[b]].destroy(), delete a[l[b]])
			...
			drawCrosshair: function(a, c) {
				...
				this.crosshair && !1 !== (r(c) || !k) ? (k ? r(c) && (d = this.isXAxis ? c.plotX : this.len - c.plotY) : d = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), r(d) && (b = this.getPlotLinePath(c && (this.isXAxis ?
						c.x : w(c.stackY, c.y)), null, null, null, d) || null), r(b) ? (c = this.categories && !this.isRadial, e || (this.cross = e = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (c ? "category " : "thin ") + l.className).attr({
						zIndex: w(l.zIndex, 2)
					}).add(), e.attr({
						stroke: l.color || (c ? n("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
		...
		a.PlotLineOrBand.prototype = {
			render: function() {
				var h = this,
					...
					y = g.events,
					c = {
						"class": "highcharts-plot-" + (v ? "band " : "line ") + (g.className || "")
					},
					G = {},
					l = m.chart.renderer,
					I = v ? "bands" : "lines",
				...
				}, g.dashStyle && (c.dashstyle = g.dashStyle)) : v && (w && (c.fill = w), g.borderWidth && (c.stroke = g.borderColor, c["stroke-width"] = g.borderWidth));
				G.zIndex = K;
				I += "-" + K;
				...
				n && c && c.length ? (q.attr({
					...
					y && a.objectEach(y, function(a, c) {
						q.on(c, function(a) {
							y[c].apply(h, [a])
						})
					})) : q && (c ? (q.show(), q.animate({
					d: c
				})) : (q.hide(), d && (h.label = d = d.destroy())));
				e && D(e.text) && c && c.length && 0 < m.width && 0 < m.height && !c.flat ? (e = r({
					align: f && v && "center",
					x: f ? !v && 4 : 10,
					verticalAlign: !f && v && "middle",
					y: f ? v ? 16 : 10 : v ? 6 : -4,
					rotation: f && !v && 90
				}, e), this.renderLabel(e, c, v, K)) : d && d.hide();
				return h
			},
		...
		a.Tooltip.prototype = {
			...
			getLabel: function() {
				...
				this.label || (this.split ? this.label =
					a.g("tooltip") : (this.label = a.label("", 0, 0, g.shape || "callout", null, null, g.useHTML, null, "tooltip").attr({
						padding: g.padding,
						r: g.borderRadius
					}), this.label.attr({
			...
			refresh: function(a, g) {
				...
				g = m[0];
				f = m[1];
				!v || b.series && b.series.noSharedTooltip ? v = b.getLabelConfig() : (B(b, function(a) {
						a.setState("hover");
				...
				!1 === v ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({
					opacity: 1
				}).show(), this.split ? this.renderSplit(v, a) : (d.style.width || e.css({
					width: this.chart.spacingBox.width
				}), e.attr({
					text: v && v.join ? v.join("") : v
				}), e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + r(b.colorIndex, q.colorIndex)), e.attr({
			...
			renderSplit: function(f, g) {
				...
				B(d, function(a) {
					...
					a.tt.attr({
						...
						anchorY: c.isHeader ? a.pos + p.plotTop - 15 : c.plotY + b.yAxis.pos
					})
				})
			},
			...
			getDateFormat: function(a, g, e, d) {
				...
				for (A in m) {
					...
					if (v[A] && f.substr(v[A]) !== "01-01 00:00:00.000".substr(v[A])) break;
					"week" !== A && (h = A)
				}
				A && (b = d[A]);
				return b
		...
		a.Pointer.prototype = {
			...
			runPointActions: function(b, d) {
				...
				if (m && (m !== e.hoverPoint || p && p.isHidden)) {
					...
					e.hoverPoint = m;
					p && p.refresh(g ? h : m, b)
				} else w && p && !p.isHidden && (c = p.getAnchor([{}], b), p.updatePosition({
					plotX: c[0],
					plotY: c[1]
				}));
			...
			drag: function(a) {
				...
				I && I.touch || (e < g ? e = g : e > g + y && (e = g + y), f < m ? f = m : f > m + G && (f = m + G), this.hasDragged = Math.sqrt(Math.pow(k - e, 2) + Math.pow(z - f, 2)), 10 < this.hasDragged && (l = b.isInsidePlot(k -
					g, z - m), b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !h && !I && (this.selectionMarker = I = b.renderer.rect(g, m, p ? 1 : y, c ? 1 : G, 0).attr({
			...
			onContainerClick: function(a) {
				var b = this.chart,
					...
					f = b.plotTop;
				a = this.normalize(a);
				b.cancelClick || (d && this.inClass(a.target, "highcharts-tracker") ? (t(d.series, "click", x(a, {
					point: d
				})), b.hoverPoint && d.firePointEvent("click", a)) : (x(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - e, a.chartY - f) && t(b, "click", a)))
			},
		...
		F(a.Pointer.prototype, {
			...
			pinchTranslateDirection: function(a, h, n, t, m, f, g, e) {
				var d =
					...
					z;
				n = function() {
					!y && 20 < Math.abs(G - I) && (c = e || Math.abs(l - k) / Math.abs(G - I));
					r = (H - l) / c + G;
			...
			pinch: function(a) {
				...
				}), g.x = [t[0].chartX, t[1] && t[1].chartX], g.y = [t[0].chartY,
					t[1] && t[1].chartY
				], B(u.axes, function(a) {
					if (a.zoomEnabled) {
				...
				}), r.res = !0) : r.followTouchMove && 1 === f ? this.runPointActions(r.normalize(a)) : t.length && (d || (r.selectionMarker = d = F({
					destroy: n,
					touch: !0
				}, u.plotBox)), r.pinchTranslate(t, m, p, d, A, g), r.hasPinched = e, r.scaleGroups(p, A), r.res && (r.res = !1, this.reset(!1, 0)))
			},
			touch: function(n, r) {
				var u = this.chart,
					t, m;
	...
	(function(a) {
		...
		if (!a.hasTouch && (x.PointerEvent || x.MSPointerEvent)) {
			var m = {},
				...
				e = function(d, e, b, f) {
					"touch" !== d.pointerType && d.pointerType !== d.MSPOINTER_TYPE_TOUCH || !B[a.hoverChartIndex] || (f(d), f = B[a.hoverChartIndex].pointer, f[e]({
						type: b,
	...
	(function(a) {
		...
		a.Legend.prototype = {
			...
			destroyItem: function(a) {
				var d = a.checkbox;
				n(["legendItem", "legendLine", "legendSymbol", "legendGroup"], function(d) {
					a[d] && (a[d] = a[d].destroy())
				});
				d && F(a.checkbox)
			},
			...
			renderTitle: function() {
				var a = this.options,
					...
					f = a.title,
					b = 0;
				f.text && (this.title || (this.title = this.chart.renderer.label(f.text, d - 3, d - 4, null, null, null, a.useHTML, null, "legend-title").attr({
					zIndex: 1
				}).css(f.style).add(this.group)), a = this.title.getBBox(), b = a.height, this.offsetWidth = a.width, this.contentGroup.attr({
					translateY: b
				}));
				this.titleHeight = b
			},
			setText: function(e) {
				var d = this.options;
				e.legendItem.attr({
					text: d.labelFormat ? a.format(d.labelFormat, e) : d.labelFormatter.call(e)
				})
			},
			renderItem: function(a) {
				...
				I || (a.legendGroup = e.g("legend-item").addClass("highcharts-" + z.type + "-series highcharts-color-" + a.colorIndex + (P ? " " +
					P : "") + (k ? " highcharts-series-" + a.index : "")).attr({
					zIndex: 1
				}).add(this.scrollGroup), a.legendItem = I = e.text("", n ? g + m : -m, this.baseline || 0, t).css(r(a.visible ? q : h)).attr({
					align: n ? "left" : "right",
					zIndex: 2
				}).add(a.legendGroup), this.baseline || (g = q.fontSize, this.fontMetrics = e.fontMetrics(g, I), this.baseline = this.fontMetrics.f + 3 + l, I.attr("y", this.baseline)), this.symbolHeight = b.symbolHeight || this.fontMetrics.f, z.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, I, t), M && this.createCheckboxForItem(a));
				this.colorizeItem(a, a.visible);
				q.width || I.css({
					width: (b.itemWidth || d.spacingBox.width) - u
				});
				this.setText(a);
				e = I.getBBox();
			...
			render: function() {
				...
				q += w;
				u || (a.box = u = f.rect().addClass("highcharts-legend-box").attr({
					r: c.borderRadius
				}).add(b), u.isNew = !0);
				u.attr({
				...
				0 < H && 0 < q && (u[u.isNew ? "attr" : "animate"](u.crisp({
					x: 0,
					y: 0,
					width: H,
					height: q
			...
			handleOverflow: function(a) {
				...
				a > e && !1 !== c.enabled ? (this.clipHeight = q = Math.max(e - 20 - this.titleHeight -
					...
					b !== l && (l = b)
				}), h || (h = d.clipRect = b.clipRect(0, m, 9999, 0), d.contentGroup.clip(h)), k(q), y || (this.nav = y = b.g().attr({
					zIndex: 1
				}).add(this.group), this.up = b.symbol("triangle", 0, 0, r, r).on("click", function() {
					d.scroll(-1, w)
				}).add(y), this.pager = b.text("", 15,
					10).addClass("highcharts-legend-navigation").css(c.style).add(y), this.down = b.symbol("triangle-down", 0, 0, r, r).on("click", function() {
					d.scroll(1, w)
				}).add(y)), d.scroll(0), a = e) : y && (k(), this.nav = y.destroy(), this.scrollGroup.attr({
					translateY: 1
				}), this.clipHeight = 0);
				return a
			},
		...
		a.LegendSymbolMixin = {
			drawRectangle: function(a, d) {
				...
				d.legendSymbol = this.chart.renderer.rect(b ? (a.symbolWidth - e) / 2 : 0, a.baseline - e + 1, b ? e : a.symbolWidth, e, x(a.options.symbolRadius, e / 2)).addClass("highcharts-point").attr({
					zIndex: 3
				}).add(d.legendGroup)
			},
			drawLineMarker: function(a) {
				...
				e && !1 !== e.enabled && (d = Math.min(x(e.radius, g), g), 0 === this.symbol.indexOf("url") && (e = r(e, {
					width: f,
					height: f
				}), d = 0), this.legendSymbol = e = m.symbol(this.symbol, b / 2 - d, a - d, 2 * d, 2 * d, e).addClass("highcharts-point").add(q), e.isMarker = !0)
			}
		};
		...
		e(O.prototype, {
			...
			redraw: function(c) {
				...
				G && (g(b, function(a) {
					...
					var c = a.min + "," + a.max;
					a.extKey !== c && (a.extKey = c, I.push(function() {
			...
			setTitle: function(a, c, b) {
				...
				g([
					...
					a = a[2];
					d && k && (l[b] = d = d.destroy());
					a && a.text && !d && (l[b] = l.renderer.text(a.text, 0, 0, a.useHTML).attr({
						align: a.align,
						"class": "highcharts-" + b,
						zIndex: a.zIndex || 4
					}).add(), l[b].update = function(a) {
						l.setTitle(!c && a, c &&
							a)
					}, l[b].css(a.style))
				});
			...
			layOutTitles: function(a) {
				...
				g(["title", "subtitle"], function(a) {
					...
					var f;
					b && (f = k.style.fontSize, f = l.fontMetrics(f, b).b, b.css({
			...
			temporaryDisplay: function(c) {
				...
				if (c)
					...
					for (; l && l.style;) "none" === b(l, "display", !1) && (l.hcOrigStyle = {
						...
						display: "block",
						overflow: "hidden"
					}, l !== this.renderTo && (c.height = 0), a.css(l, c), l.style.setProperty && l.style.setProperty("display", "block", "important")), l = l.parentNode
			},
			...
			drawChartBox: function() {
				...
				r = "animate";
				e || (r = "attr", this.plotBorder = e = c.rect().addClass("highcharts-plot-border").attr({
					zIndex: 1
				}).add());
				e.attr({
			...
			renderLabels: function() {
				...
				c.items && g(c.items, function(b) {
					...
					delete d.left;
					delete d.top;
					a.renderer.text(b.html, k, f).attr({
						zIndex: 2
					}).css(d).add()
				})
			},
			...
			isReadyToRender: function() {
				var a = this;
				return Q || N != N.top ||
					"complete" === n.readyState ? !0 : (n.attachEvent("onreadystatechange", function() {
	...
	(function(a) {
		...
		a.Point.prototype = {
			...
			firePointEvent: function(a, f, g) {
				...
				(d.point.events[a] || e.options && e.options.events && e.options.events[a]) && this.importEvents();
				"click" === a && d.allowPointSelect && (g = function(a) {
	...
	(function(a) {
		...
		a.Series = a.seriesType("line", null, {
			...
			setData: function(c, e, l, f) {
				...
				q = c.length;
				e = H(e, !0);
				if (!1 !== f && q && y === q && !k.cropped && !k.hasGroupedData && k.visible) t(c, function(a, c) {
					...
					if (I && q > I) {
						...
						for (l = 0; l < q; l++) void 0 !== c[l] && (w = {
							series: k
						}, k.pointClass.prototype.applyOptions.apply(w, [c[l]]), k.updateParallelArrays(w, l));
					b(n[0]) && a.error(14, !0);
					k.data = [];
			...
			setClip: function(a) {
				var c = this.chart,
					...
					p = c[g],
					q = c[g + "m"];
				p || (a && (f.width = 0, c[g + "m"] = q = d.clipRect(-99, k ? -c.plotLeft : -c.plotTop, 99, k ? c.chartWidth : c.chartHeight)), c[g] = p = d.clipRect(f), p.count = {
					length: 0
				});
			...
			drawGraph: function() {
				...
				t(d, function(d, l) {
					...
					e ? (e.endX = b.xMap, e.animate({
						d: b
					})) : b.length && (a[k] = a.chart.renderer.path(b).addClass(d[1]).attr({
						zIndex: 1
					}).add(a.group), e = {
						stroke: d[2],
						"stroke-width": c.lineWidth,
						fill: a.fillGraph && a.color || "none"
					}, d[3] ? e.dashstyle = d[3] : "square" !== c.linecap && (e["stroke-linecap"] = e["stroke-linejoin"] = "round"), e = a[k].attr(e).shadow(2 > l && c.shadow));
			...
			applyZones: function() {
				...
				d.length && (p || q) && w && void 0 !== w.min && (v = w.reversed, r = w.horiz, p && p.hide(), q && q.hide(), h = w.getExtremes(), t(d, function(d, l) {
					...
					w.isXAxis ? (g = {
						...
						width: K,
						height: m
					}, r || (g.x = c.plotHeight - g.x)) : (g = {
						x: 0,
						y: n ? u : A,
						width: m,
						height: K
					}, r && (g.y = c.plotWidth - g.y));
					n && b.isVML && (g = w.isXAxis ? {
						x: 0,
						y: v ? A : u,
						height: g.width,
						width: c.chartWidth
			...
			plotGroup: function(a, c, b, d, k) {
				var l = this[a],
					e = !l;
				e && (this[a] = l = this.chart.renderer.g().attr({
					zIndex: d || .1
				}).add(k));
	...
	(function(a) {
		...
		E.prototype = {
			...
			render: function(a) {
				...
				this.label ? this.label.attr({
					text: g,
					visibility: "hidden"
				}) : this.label = this.axis.chart.renderer.text(g, null, null, f.useHTML).css(f.style).attr({
		...
		B.prototype.renderStackTotals =
			function() {
				...
				e || (this.stackTotalGroup = e = f.g("stack-labels").attr({
					visibility: "visible",
					zIndex: 6
				}).add());
		...
		B.prototype.cleanStacks = function() {
			...
			this.isXAxis || (this.oldStacks &&
				(a = this.stacks = this.oldStacks), x(a, function(a) {
					x(a, function(a) {
						a.cum = a.total
					})
				}))
	...
	(function(a) {
		...
		x(a.Chart.prototype, {
			...
			showLoading: function(a) {
				...
				d || (c.loadingDiv = d = D("div", {
					className: "highcharts-loading highcharts-loading-hidden"
				}, null, c.container), c.loadingSpan = D("span", {
		...
		h("area", "line", {
			...
			getGraphPath: function(a) {
				...
				for (f = 0; f < a.length; f++)
					if (g = a[f].isNull, b = D(a[f].rectPlotX, a[f].plotX), q = D(a[f].yBottom, H), !g || u) u || J(f, f - 1, "left"), g && !t && u || (d.push(a[f]), e.push({
						x: f,
						plotX: b,
						plotY: q
					})), u || J(f, f + 1, "right");
			...
			drawGraph: function() {
				...
				B(t, function(m) {
					var f = m[0],
						g = a[f];
					g ? (g.endX = h.xMap, g.animate({
						d: h
					})) : (g = a[f] = a.chart.renderer.path(h).addClass(m[1]).attr({
						fill: D(m[3],
	...
	(function(a) {
		...
		x("column", "line", {
			...
			init: function() {
				...
				var a = this,
					f = a.chart;
				f.hasRendered && F(f.series, function(f) {
			...
			getColumnMetrics: function() {
				...
				a.columnMetrics = {
					width: f,
					offset: (q - f) / 2 + (n + ((a.columnIndex || 0) + (d ? 1 : 0)) * q - v / 2) * (d ? -1 : 1)
				};
			...
			animate: function(a) {
				var f = this,
					...
					p = {};
				t && (a ? (p.scaleY = .001, a = Math.min(g.pos + g.len, Math.max(g.pos, g.toPixels(e.threshold))), d ? p.translateX = a - g.len : p.translateY = a, f.group.attr(p)) : (p[d ? "translateX" : "translateY"] = g.pos, f.group.animate(p, D(E(f.options.animation), {
					step: function(a, d) {
						f.group.attr({
		...
		t("pie", "line", {
			...
			translate: function(a) {
				...
				this.getX = function(c, b, d) {
					v = Math.asin(Math.min((c - a[1]) / (a[2] / 2 + d.labelDistance), 1));
				...
				F(a.points, function(f) {
					if (!f.isNull) {
						...
						p = a.pointAttribs(f, f.selected &&
							"select");
						d ? d.setRadialReference(a.center).attr(p).animate(D(b, e)) : (f.graphic = d = g[f.shapeType](b).setRadialReference(a.center).attr(e).add(a.group), f.visible || d.attr({
							visibility: "hidden"
						}), d.attr(p).attr({
							"stroke-linejoin": "round"
						}).shadow(h, m));
			...
			haloPath: function(a) {
				...
				return this.sliced ||
					!this.visible ? [] : this.series.chart.renderer.symbols.arc(f.x, f.y, f.r + a, f.r + a, {
	...
	(function(a) {
		...
		f.prototype.drawDataLabels = function() {
			var d = this,
				...
				u = d.chart.renderer;
			if (b.enabled || d._hasPointLabels) d.dlProcessOptions && d.dlProcessOptions(b), c = d.plotGroup("dataLabelsGroup", "data-labels", w && !q ? "hidden" : "visible", b.zIndex || 6), w && (c.attr({
				opacity: +q
			}), q || E(d, "afterAnimate", function() {
				d.visible && c.show(!0);
				c[e.animation ?
					"animate" : "attr"]({
					opacity: 1
		...
		f.prototype.alignDataLabel = function(a, e, b, f, g) {
			...
			if (l && (m = b.style.fontSize, m = d.renderer.fontMetrics(m, e).b, f = n({
					...
					width: p.width,
					height: p.height
				}), v ? (I = !1, h = d.renderer.rotCorr(m, v), h = {
				...
				}, e[g ? "attr" : "animate"](h).attr({
					align: r
				}), c = (v + 720) % 360, c = 180 < c && 360 > c, "left" === r ? h.y -= c ? p.height : 0 : "center" === r ? (h.x -= p.width / 2, h.y -= p.height / 2) : "right" === r && (h.x -= p.width, h.y -= c ? 0 : p.height)) : (e.align(b, null, f), h = e.alignAttr), I ? a.isLabelJustified = this.justifyDataLabel(e, b, h, p, f, g) : t(b.crop, !0) && (l = d.isInsidePlot(h.x,
					h.y) && d.isInsidePlot(h.x + p.width, h.y + p.height)), b.shape && !v)) e[g ? "attr" : "animate"]({
		...
		g.pie && (g.pie.prototype.drawDataLabels = function() {
			...
			d.visible && (h.enabled || d._hasPointLabels) && (D(e, function(a) {
				...
				if (w)
					for (d.sortByAngle(e, f - .5), 0 < d.maxLabelDistance && (q = Math.max(0, u - y - d.maxLabelDistance), p = Math.min(u + y + d.maxLabelDistance, g.plotHeight), D(e, function(a) {
							0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, u - y - a.labelDistance), a.bottom =
								Math.min(u + y + a.labelDistance, g.plotHeight), t = a.dataLabel.getBBox().height || 21, a.positionsIndex = v.push({
									target: a.labelPos[1] - a.top + t / 2,
									size: t,
									rank: a.y
								}) - 1)
						}), a.distribute(v, p + t - q)), O = 0; O < w; O++) b = e[O], p = b.positionsIndex, k = b.labelPos, l = b.dataLabel, E = !1 === b.visible ? "hidden" : "inherit", q = k[1], v && F(v[p]) ? void 0 === v[p].pos ? E = "hidden" : (z = v[p].size, N = b.top + v[p].pos) : N = q, delete b.positionIndex, M = h.justify ? r[0] + (f ? -1 : 1) * (y + b.labelDistance) : d.getX(N < b.top + 2 || N > b.bottom - 2 ? q : N, f, b), l._attr = {
							visibility: E,
							align: k[6]
						},
						l._pos = {
							...
							y: N + h.y - 10
						}, k.x = M, k.y = N, I = l.getBBox().width, q = null, M - I < m ? (q = Math.round(I - M + m), C[3] = Math.max(q, C[3])) : M + I > n - m && (q = Math.round(M + I - n + m), C[1] = Math.max(q, C[1])), 0 > N - z / 2 ? C[0] = Math.max(Math.round(-N + z / 2), C[0]) : N + z / 2 > c && (C[2] = Math.max(Math.round(N + z / 2 - c), C[2])), l.sideOverflow = q
				...
				if ((l = a.dataLabel) && l._pos && a.visible && 0 < a.labelDistance) {
					...
					if (c = !w) a.connector = w = g.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(d.dataLabelsGroup), w.attr({
						"stroke-width": q,
		...
		g.column && (g.column.prototype.alignDataLabel = function(a, e, b, g, h) {
			...
			p && (g = r(p), 0 > g.y && (g.height += g.y, g.y = 0), p = g.y + g.height - q.yAxis.len, 0 < p && (g.height -= p), d && (g = {
				x: q.yAxis.len - g.y - g.height,
				y: q.xAxis.len - g.x - g.width,
				width: g.height,
				height: g.width
			}), m || (d ? (g.x += c ? 0 : g.width, g.width = 0) : (g.y += c ? g.height : 0, g.height = 0)));
		...
		r(p.prototype, {
			select: function(a, b) {
				...
				c.firePointEvent(a ? "select" : "unselect", {
					...
					c.setState(a && "select");
					b || u(f.getSelectedPoints(), function(a) {
			...
			setState: function(a,
				...
				if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (k || l && !1 === q.enabled) || a && n.states && n.states[a] && !1 === n.states[a].enabled)) {
					...
					if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" +
					...
					}(c = g.halo) && c.size ? (t || (f.halo = t = v.renderer.path().add((this.graphic || m).parentGroup)), t[b ? "animate" : "attr"]({
						...
						zIndex: -1
					}, c.attributes))) : t && t.point && t.point.haloPath && t.animate({
		...
		r(b.prototype, {
			...
			setState: function(a) {
				...
				if (b.state !== a && (u([b.group, b.markerGroup, b.dataLabelsGroup], function(c) {
					...
					for (g = {
							"stroke-width": g
						}, e.animate(g, d(b.chart.options.chart.animation, f[a] && f[a].animation)); b["zone-graph-" + c];) b["zone-graph-" + c].attr(g), c += 1
			},
	...
	(function(a) {
		...
		E.prototype.setResponsive = function(h) {
			...
			var f = a.merge.apply(0, a.map(r, function(f) {
				...
				r = r.toString() || void 0;
			r !== (m && m.ruleIds) && (m && this.update(m.undoOptions, h), r ? (this.currentResponsive = {
				ruleIds: r,
				mergedOptions: f,
				undoOptions: this.currentOptions(f)
			}, this.update(f, h)) : this.currentResponsive = void 0)
		};
	...
	(function(a) {
		...
		m(a.Series.prototype, "init", function(a) {
			...
			(f = this.xAxis) && f.options.ordinal && E(this, "updatedData", function() {
		...
		r(B.prototype, {
			...
			getExtendedPositions: function() {
				...
				e[d] || (b = {
					...
					b.series.push(m)
				}), this.beforeSetTickPositions.apply(b), e[d] = b.ordinalPositions);
				return e[d]
			},
		...
		m(F.prototype, "pan", function(a, g) {
			...
			if (e.options.ordinal && e.series.length) {
				var b = this.mouseDownX,
					...
					t = e.val2lin,
					y;
				w.ordinalPositions ? 1 < Math.abs(b) && (r && u(r, function(a) {
						a.setState()
					}), 0 > b ? (r = w, y = e.ordinalPositions ? e : w) : (r = e.ordinalPositions ? e : w, y = w), w = y.ordinalPositions, m > w[w.length - 1] && w.push(m), this.fixedRange = q - n, b = e.toFixedRange(null, null, c.apply(r, [t.apply(r, [n, !0]) + b, !0]), c.apply(y, [t.apply(y, [q, !0]) + b, !0])), b.min >= Math.min(h.dataMin, n) &&
					b.max <= Math.max(m, q) && e.setExtremes(b.min, b.max, !0, !1, {
						trigger: "pan"
					}), this.mouseDownX = d, D(this.container, {
						cursor: "move"
					})) : f = !0
			} else f = !0;
	...
	(function(a) {
		...
		a.Series.prototype.gappedPath = function() {
			var a =
				...
				g = f.length - 1;
			if (a && 0 < g)
				for (; g--;) f[g + 1].x - f[g].x > this.closestPointRange * a && f.splice(g + 1, 0, {
					isNull: !0
				});
	...
	(function(a) {
		...
		d.groupData = function(a, b, d, e) {
			...
			for (A; A <= m; A++) {
				...
				if (u) {
					n = this.cropStart + A;
					var B = c && c[n] || this.pointClass.prototype.applyOptions.apply({
							series: this
						}, [f[n]]),
						D;
					for (n = 0; n < t; n++) D =
		...
		e(g.prototype, "tooltipFooterHeaderFormatter", function(c, b, d) {
			...
			return h && "datetime" === h.options.type && l && x(b.key) ? (c = e.currentDataGrouping, l = l.dateTimeLabelFormats, c ? (h = l[c.unitName], 1 === c.count ? g = h[0] : (g = h[1], k = h[2])) :
				!g && l && (g = this.getXDateFormat(b, f, h)), g = p(g, b.key), k && (g += p(k, b.key + c.totalRange - 1)), r(f[(d ? "footer" : "header") + "Format"], {
					point: u(b.point, {
						key: g
					}),
					series: e
			...
			drawPoints: function() {
				...
				E(a.points, function(n) {
					...
					void 0 !== n.plotY && (f || (n.graphic = f = h.renderer.path().add(a.group)), f.attr(a.pointAttribs(n, n.selected && "select")), u = f.strokeWidth() %
						2 / 2, g = Math.round(n.plotX) - u, t = Math.round(n.shapeArgs.width / 2), m = ["M", g, Math.round(n.yBottom), "L", g, Math.round(n.plotHigh)], null !== n.open && (r = Math.round(n.plotOpen) + u, m.push("M", g, r, "L", g - t, r)), null !== n.close && (r = Math.round(n.plotClose) + u, m.push("M", g, r, "L", g + t, r)), f[e ? "attr" : "animate"]({
							d: m
			...
			drawPoints: function() {
				...
				B(a.points, function(h) {
					...
					void 0 !== h.plotY && (r || (h.graphic = r = n.renderer.path().add(a.group)), r.attr(a.pointAttribs(h, h.selected && "select")).shadow(a.options.shadow), e = r.strokeWidth() % 2 / 2, d = Math.round(h.plotX) - e, t = h.plotOpen, m = h.plotClose, f = Math.min(t, m), t = Math.max(t, m), p = Math.round(h.shapeArgs.width /
						2), m = Math.round(f) !== Math.round(h.plotHigh), g = t !== h.yBottom, f = Math.round(f) + e, t = Math.round(t) + e, e = [], e.push("M", d - p, t, "L", d - p, f, "L", d + p, f, "L", d + p, t, "Z", "M", d, f, "L", d, m ? Math.round(h.plotHigh) : f, "M", d, t, "L", d, g ? Math.round(h.yBottom) : t), r[b ? "attr" : "animate"]({
						d: e
	...
	(function(a) {
		...
		h("flags", "column", {
				...
				if (h && h.visible && r)
					for (w = (h.pointXOffset || 0) + (h.barW || 0) /
						2, h = h.currentDataGrouping, y = v[r - 1].x + (h ? h.totalRange : 0), m(e, function(a, c) {
							return a.x - c.x
						}), a = "plot" + a[0].toUpperCase() + a.substr(1); r-- && e[d] && !(h = e[d], x = v[r], x.x <= h.x && void 0 !== x[a] && (h.x <= y && (h.plotY = x[a], x.x < h.x && !n && (G = v[r + 1]) && void 0 !== G[a] && (h.plotY += (h.x - x.x) / (G.x - x.x) * (G[a] - x[a]))), d--, r++, 0 > d)););
				B(e, function(a, d) {
					var f;
			...
			drawPoints: function() {
				...
				}).addClass("highcharts-point").add(this.markerGroup), q.graphic.div && (q.graphic.div.point = q), t.shadow(b.shadow)), 0 < d && (d -= t.strokeWidth() % 2), t.attr({
					text: q.options.title || b.title || "A",
					x: d,
					y: h,
					anchorX: c,
					anchorY: w
				}), q.tooltipPos = g.inverted ? [y.len + y.pos - g.plotLeft - h, this.xAxis.len - d] : [d, h + y.pos - g.plotTop]) : t && (q.graphic = t.destroy());
			...
			drawTracker: function() {
				...
				B(a, function(f) {
					...
					e && E(e.element, "mouseover", function() {
						0 < f.stackIndex && !f.raised && (f._y = e.y, e.attr({
							y: f._y - 8
						}), f.raised = !0);
						B(a, function(a) {
	...
	(function(a) {
		...
		E.prototype = {
			...
			setRange: function(a, b) {
				...
				h(f) && (a = Math.max(a, 0), g = Math.ceil(f * a), this.calculatedWidth = m = D(f * Math.min(b, 1) - g), m < c && (g = (f - c + m) * a, m = c), c = Math.floor(g + this.xOffset + this.yOffset), f = m / 2 - .5, this.from = a, this.to = b, e ? (this.scrollbarGroup[n]({
						translateY: c
					}), this.scrollbar[n]({
						height: m
					...
					translateX: f
				}), this.scrollbarLeft = c, this.scrollbarTop = 0), 12 >= m ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), !1 === d.showFull && (0 >= a && 1 <= b ? this.group.hide() : this.group.show()), this.rendered = !0)
			},
			initEvents: function() {
				var a = this;
				a.mouseMoveHandler = function(b) {
					...
					!a.grabbedCenter || b.touches && 0 === b.touches[0][e] ||
						(d = a.cursorToScrollbarPosition(d)[e], e = a[e], e = d - e, a.hasDragged = !0, a.updatePosition(c[0] + e, c[1] + e), a.hasDragged && t(a, "changed", {
							from: a.from,
							to: a.to,
							trigger: "scrollbar",
							DOMType: b.type,
			...
			destroy: function() {
				...
				this.removeEvents();
				x(["track", "scrollbarRifles", "scrollbar", "scrollbarGroup", "group"], function(a) {
		...
		E.prototype = {
			...
			render: function(a, b, c, d) {
				...
				if (!this.hasDragged || u(c)) {
					...
					m && (this.navigatorGroup.attr({
						visibility: "visible"
					}), q = q && !this.hasDragged ? "animate" : "attr", this.drawMasks(c, n, l, q), this.drawOutline(c, n, l, q), this.drawHandle(c, 0, l, q), this.drawHandle(n, 1, l, q));
			...
			shadesMousedown: function(a, b) {
				...
				1 === b ? (this.grabbedCenter = h, this.fixedWidth = g, this.dragOffset =
					h - e) : (a = h - f - g / 2, 0 === b ? a = Math.max(0, a) : 2 === b && a + g >= l && (a = l - g, m = this.getUnionExtremes().dataMax), a !== e && (this.fixedWidth = g, b = d.toFixedRange(a, a + g, null, m), c.xAxis[0].setExtremes(Math.min(b.min, b.max), Math.max(b.min, b.max), !0, null, {
					trigger: "navigator"
				})))
			},
			...
			onMouseMove: function(a) {
				...
				a.touches && 0 === a.touches[0].pageX || (a = c.pointer.normalize(a), c = a.chartX, g && (d = b.top, c = a.chartY), b.grabbedLeft ? (b.hasDragged = !0, b.render(0, 0, c - d, b.otherHandlePos)) : b.grabbedRight ? (b.hasDragged = !0, b.render(0, 0, b.otherHandlePos, c - d)) : b.grabbedCenter && (b.hasDragged = !0, c < l ? c = l : c > e + l - f && (c = e + l - f), b.render(0,
					0, c - l, c - l + f)), b.hasDragged && b.scrollbar && b.scrollbar.options.liveRedraw && (a.DOMType = a.type, setTimeout(function() {
					b.onMouseUp(a)
				}, 0)))
			},
			onMouseUp: function(a) {
				...
				(!this.hasDragged || d && d.hasDragged) && "scrollbar" !== a.trigger || (this.zoomedMin === this.otherHandlePos ? e = this.fixedExtreme : this.zoomedMax === this.otherHandlePos && (f = this.fixedExtreme), this.zoomedMax === this.size && (f = this.getUnionExtremes().dataMax), c = c.toFixedRange(this.zoomedMin, this.zoomedMax,
					e, f), u(c.min) && b.xAxis[0].setExtremes(Math.min(c.min, c.max), Math.max(c.min, c.max), !0, this.hasDragged ? !1 : null, {
					trigger: "navigator",
			...
			removeBaseSeriesEvents: function() {
				var a =
					this.baseSeries || [];
				this.navigatorEnabled && a[0] && !1 !== this.navigatorOptions.adaptToUpdatedData && (t(a, function(a) {
			...
			init: function(a) {
				...
				a.isDirtyBox = !0;
				g.navigatorEnabled ? (g.xAxis = new F(a, A({
						...
						height: b
					})), e || c.series.data ? g.addBaseSeries() : 0 === a.series.length && w(a, "redraw", function(b, c) {
						0 < a.series.length && !g.series && (g.setBaseSeries(), a.redraw = b);
						b.call(a, c)
					}), g.renderElements(),
					g.addMouseEvents()) : g.xAxis = {
				...
				a.options.scrollbar.enabled && (a.scrollbar = g.scrollbar = new q(a.renderer, A(a.options.scrollbar, {
			...
			getUnionExtremes: function(a) {
				var b = this.chart.xAxis[0],
					...
					f;
				a && null === b.dataMin || (f = {
					dataMin: v(d && d.min, G("min", e.min, b.dataMin, c.dataMin, c.min)),
					dataMax: v(d && d.max, G("max", e.max, b.dataMax, c.dataMax, c.max))
				});
				return f
			},
			setBaseSeries: function(a) {
				...
				this.series && (this.removeBaseSeriesEvents(), t(this.series, function(a) {
					a.destroy()
				}));
				c = this.baseSeries = [];
			...
			addBaseSeries: function() {
				...
				}) : (f = A(g, m), f.data = g.data, a.hasNavigatorData = !!f.data, c.push(b.initSeries(f)));
			...
			addBaseSeriesEvents: function() {
				...
				!1 !== this.navigatorOptions.adaptToUpdatedData && t(b, function(b) {
		...
		E.prototype = {
			clickButton: function(a, d) {
				...
				if (null !== k && null !== n) {
					...
					if ("month" === t || "year" === t) h ? (t = {
						...
						dataMin: k,
						dataMax: n
					}, p = h.minFromRange.call(t), b(t.newMax) && (r = t.newMax)) : m = f;
					...
					c.setSelected(a);
					h ? h.setExtremes(p, r, v(d, 1), null, {
						trigger: "rangeSelectorButton",
						rangeSelectorButton: f
					}) : (u = q(e.options.xAxis)[0], A = u.range, u.range = m, C = u.min, u.min = w, B(e, "load", function() {
						u.range = A;
						u.min = C
					}))
				}
			...
			updateButtonStates: function() {
				...
				g(this.buttonOptions, function(a, b) {
					...
					("month" === g || "year" === g) && e >= 864E5 * {
						...
						month: 31,
						year: 366
					}[g] * t ? c = !0 : "ytd" === g ? (c = k - m === e, x = !b) : "all" === g && (c = d.max - d.min >= l - h, y = !b && p && c);
					g = !q && (w || v || y || f);
					c = b && c || c && !p && !x;
					g ? u = 3 : c && (p = !0, u = 2);
			...
			drawInput: function(a) {
				function c() {
					...
					c !== q.previousValue && (q.previousValue = c, b(c) || (c = a.split("-"), c = Date.UTC(H(c[0]), H(c[1]) - 1, H(c[2]))), b(c) && (x || (c += 6E4 * (new Date).getTimezoneOffset()),
						p ? c > d.maxInput.HCTime ? c = void 0 : c < k && (c = k) : c < d.minInput.HCTime ? c = void 0 : c > g && (c = g), void 0 !== c && e.setExtremes(p ? c : e.min, p ? e.max : c, void 0, void 0, {
				...
				this[a + "Label"] = t = l.label(r.lang[p ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).addClass("highcharts-range-label").attr({
					padding: 2
				}).add(u);
				u.offset += t.width + 5;
			...
			render: function(a, b) {
				...
				!1 !== n.enabled && (F || (c.group = E = f.g("range-selector-buttons").add(),
					c.zoomText = f.text(m.rangeSelectorZoom, v(w.x, A), 15).css(n.labelStyle).add(E), B = v(w.x, A) + c.zoomText.getBBox().width + 5, g(c.buttonOptions, function(a, b) {
						p[b] = f.button(a.text, B, 0, function() {
							c.clickButton(b);
							c.isActive = !0
						}, u, C && C.hover, C && C.select, C && C.disabled).attr({
							"text-align": "center"
						}).add(E);
						B += p[b].width + v(n.buttonSpacing, 5)
					}), !1 !== x && (c.div = q = h("div", null, {
							position: "relative",
							height: 0,
							zIndex: 1
						}), l.parentNode.insertBefore(q, l), c.inputGroup = q = f.g("input-group").add(), q.offset = 0, c.drawInput("min"),
						c.drawInput("max"))), c.updateButtonStates(), E[F ? "animate" : "attr"]({
					translateY: D.buttonTop
				}), !1 !== x && (q.align(e({
					y: D.inputTop,
					width: q.offset,
					x: k && D.inputTop < (k.y || 0) + k.height - d.spacing[0] ? -40 : 0
				}, n.inputPosition), !0, d.spacingBox), t(x) || (d = E.getBBox(), q[q.alignAttr.translateX < d.x + d.width + 10 ? "hide" : "show"]()), c.setInputValue("min", a), c.setInputValue("max", b)), c.rendered = !0)
			},
			update: function(a) {
				var b = this.chart;
			...
			destroy: function() {
				...
				a.objectEach(b, function(a, c) {
					a && "chart" !== c && (a.destroy ? a.destroy() : a.nodeType && f(this[c]));
	...
	(function(a) {
		...
		a.StockChart = a.stockChart = function(b, c, h) {
			...
			l = e({
				...
				scrollbar: {
					enabled: d(n.scrollbar.enabled, !0)
				},
				rangeSelector: {
		...
		J(D.prototype, "update", function(a, b) {
			"scrollbar" in b && this.navigator && (e(!0, this.options.scrollbar, b.scrollbar), this.navigator.update({}, !1), delete b.scrollbar);
