...
class ExchangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post exchanges_url, params: { exchange: { country: @exchange.country, description: @exchange.description, icon: @exchange.icon, memo: @exchange.memo, name: @exchange.name, price_memo: @exchange.price_memo, rank: @exchange.rank, stars: @exchange.stars, support_type: @exchange.support_type, trade_pair_count: @exchange.trade_pair_count, web_site: @exchange.web_site } }
    end
  ...
  test "should update exchange" do
    patch exchange_url(@exchange), params: { exchange: { country: @exchange.country, description: @exchange.description, icon: @exchange.icon, memo: @exchange.memo, name: @exchange.name, price_memo: @exchange.price_memo, rank: @exchange.rank, stars: @exchange.stars, support_type: @exchange.support_type, trade_pair_count: @exchange.trade_pair_count, web_site: @exchange.web_site } }
